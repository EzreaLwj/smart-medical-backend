...
public interface MedicalPatientMapper extends BaseMapper<MedicalPatient> {
    ...
    List<MedicalPatient> queryPatientInfoList(@Param("request") PatientQueryEntity patientQueryRequest);

    Long queryPatientInfoListCount(@Param("request") PatientQueryEntity patientQueryRequest);
}
